...
void voir_si_l_auteur_a_coecrit_article_deja_traiter(fiche_minimal *fiche_i, char *auteur_k, ll_list *Gt, stade_de_traitement_de_Gt_pour_l_article_Ai *etat_de_Gt);

void parcours_liste_des_auteurs_d_un_article_pour_voir_si_il_faut_creer_une_nouvelle_liste(fiche_minimal *fiche_i, ll_list * Gt, stade_de_traitement_de_Gt_pour_l_article_Ai *etat_de_Gt);
